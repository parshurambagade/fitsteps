...
const FireIcon = createIcon({
  ...
  path: (
    <>
      <Path
        d="M12 22C16.4183 22 20 18.4183 20 14C20 11 18 9 17 8C17 11 14.4 12 13 12C14 8 12 5 9 3C9.5 6.5 8 9 6 11C4.5 12.5 3 14.5 3 16.5C3 19.5366 7.58172 22 12 22Z"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <Path
        d="M12 16C13.6569 16 15 14.6569 15 13C15 11 14 10 13.5 9.5C13.5 11 12 11.5 11.5 11.5C12 9.5 11 8 9.5 7C9.75 8.75 9 10 8 11C7.25 11.75 6.5 12.75 6.5 13.75C6.5 15.0711 8.34315 16 12 16Z"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
